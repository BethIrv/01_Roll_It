...
number of points that you earned.

If your first roll of two dice is a double (eg: both of the dice show a three),
...
while user_score < target_score and comp_score < target_score:
    ...
    if double_points == "yes":
        print("😸 If you win this round, you will gain double points! 😸")
    ...
    while computer_points <= 13 and user_points <= 13:
        ...
        if roll_again == "yes":
            ...
            if user_points > 13:
                print(f"🙀🙀 Uh Oh! You've rolled a {user_points} so your total is {user_points}."
        ...
        # has been met in a previous iteration through the loop.
            ...
            if computer_points > 13:
                print(f"🙀 The computer has rolled a {computer_move}, taking their points"
